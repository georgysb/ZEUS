...
0x3E, 0x20, 0xCD, 0x89, 0x93, 0xED, 0x53, 0x0C, 0xFE, 
0xC9, 
//---------------
...
0x21, 0xFF, 0xFE, 0x71, 0xAF, 0xED, 0x6F, 0xC6, 0x40, 0x6F, 0x26, 0x80, 0x7E, 0xCD, 0x89, 0x93, 
0x21, 0xFF, 0xFE, 0x71, 0xAF, 0xED, 0x67, 0xC6, 0x40, 0x6F, 0x26, 0x80, 0x14, 0xCD, 0x30, 0x93, 0x7E, 0xCD, 0x89, 0x93, 
0xE1, 0xC1, 
0xC9, 
//---------------
...
0x2E, 0x00, 0x11, 0x70, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x10, 0x1C, 0xE5, 0x7D, 0x21, 0x04, 0xFE, 0xBE, 0xE1, 0x20, 0xF1, 0xCD, 0x00, 0x97, 0xE1, 0xC1, 0xC9, // "clr" check(26)
0x2E, 0x00, 0x11, 0x73, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x7E, 0x97, 0xE1, 0xC1, 0xC9, // "dump " check(21)
0x2E, 0x00, 0x11, 0x78, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xEA, 0x97, 0xE1, 0xC1, 0xC9, // "send " check
0x2E, 0x00, 0x11, 0x7D, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x2F, 0x98, 0xE1, 0xC1, 0xC9, // "load " check
0x2E, 0x00, 0x11, 0x82, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x6A, 0x98, 0xE1, 0xC1, 0xC9, // "move " check
0x2E, 0x00, 0x11, 0x87, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xB1, 0x98, 0xE1, 0xC1, 0xC9, // "jump " check
0x2E, 0x00, 0x11, 0x8C, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xCB, 0x98, 0xE1, 0xC1, 0xC9, // "exec " check
0x2E, 0x00, 0x11, 0x91, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x00, 0x99, 0xE1, 0xC1, 0xC9, // "sysl " check
0x2E, 0x00, 0x11, 0x96, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x46, 0x99, 0xE1, 0xC1, 0xC9, // "sysh " check
0x2E, 0x00, 0x11, 0x9B, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x8E, 0x99, 0xE1, 0xC1, 0xC9, // "out " check
0x2E, 0x00, 0x11, 0x9F, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xA7, 0x99, 0xE1, 0xC1, 0xC9, // "inp " check
0x2E, 0x00, 0x11, 0xA3, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xC1, 0x99, 0xE1, 0xC1, 0xC9, // "crc7 " check
0x2E, 0x00, 0x11, 0xA8, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xFB, 0x99, 0xE1, 0xC1, 0xC9, // "sdi " check
...
0xC9, 
//---------------//>"jump " command $98B1(+0x001A)
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, 
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x47, 
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
0xC5, 0xE1, 0xE9, 
0xC9, 
//---------------//>"exeс " command $98CB(+0x0035)
...
0xD5, 0x11, 0x0E, 0x23, 0xCD, 0x30, 0x93, //set cell pos.
0x3A, 0x81, 0xFE, 0xD3, 0xF0, 0xCD, 0x3C, 0x95, 0xD1, //output state to sysreg and TFT
0xC9, 
//---------------//>"sysh " command $9946(+0x0048)
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, 
0x2C, 0x56, 0xC5, 0xE5, 0x3A, 0x81, 0xFE, 0x21, 0xFF, 0xFE, 0x77, 
0x01, 0x10, 0x00, 0x21, 0x5F, 0x80, 0x7A, 0xED, 0xB9, 0x79, 0x28, 0x0A, 
...
0x3A, 0x81, 0xFE, 0xD3, 0xF0, 0xCD, 0x3C, 0x95, 0xD1, //output state to sysreg and TFT
0xC9, 
//---------------//>"out " command $998E(+0x0019)
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x04, 
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
0x2C, 0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 
0xED, 0x79,       //write A to sys reg
0xC9, 
//---------------//>"inp " command $99A7(+0x001A)
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x04, 
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
0x11, 0x01, 0x00, 0xCD, 0x30, 0x93, //set pos.
0xED, 0x78, 0xCD, 0x3C, 0x95, //print port
0xC9, 
//---------------//>"crc7 " command $99C1(+0x003A)
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x04, 0x01, 0x00, 0x01, 
...
0x11, 0x01, 0x00, 0xCD, 0x30, 0x93, //set print pos, 
0x7E, 0xCD, 0x3C, 0x95, // print (HL)
0xC9, 
//---------------//>"sdi " command (L bytes at $0100) $99FB(+0x0038)
...
0x11, 0x0E, 0x26, 0xCD, 0x30, 0x93, 0x3E, 0xFF, 0x90, 0xCD, 0x3C, 0x95, //aval. banks number print
0x16, 0x25, 0xCD, 0x30, 0x93, 0x3E, 0x2F, 0xCD, 0x89, 0x93, //print "/"
//----------------------------------------------------------------------- Bank E init
0x3A, 0x81, 0xFE, 0x21, 0xFF, 0xFE, 0x77, 
0x3E, 0xFE, 0xED, 0x67, 0x7E, 0xED, 0x67, 0x7E, //SYSREG state low nibble write
0x32, 0x81, 0xFE, 
0x11, 0x0E, 0x23, 0xCD, 0x30, 0x93, //set cell pos.
0x3A, 0x81, 0xFE, 0xD3, 0xF0, 0xCD, 0x3C, 0x95, //output state to sysreg and TFT
//----------------------------------------------------------------------- UART ready
