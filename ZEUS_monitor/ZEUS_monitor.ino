...
0x16, 0x2A, 0xCD, 0x09, 0xFC, 0x54, 0xCD, 0x0D, 0xFC, 0x55, 0xCD, 0x0D, 0xFC, 
0x16, 0x00, 0x1E, 0x07, 0x19, 0x54, 0xCD, 0x0D, 0xFC, 0x55, 0xCD, 0x0D, 0xFC, 
0xD1, 0xD5, 
0x6B, 0x26, 0x00, 0x0E, 0x04, 0x37, 0x3F, 0xCB, 0x15, 0xCB, 0x14, 0x0D, 0x20, 0xF7, 
0x16, 0x2B, 0xCD, 0x09, 0xFC, 0x54, 0xCD, 0x0D, 0xFC, 0x55, 0xCD, 0x0D, 0xFC, 
0x16, 0x00, 0x1E, 0x0F, 0x19, 0x54, 0xCD, 0x0D, 0xFC, 0x55, 0xCD, 0x0D, 0xFC, 
0xD1, 0xC1, 0xE1, 
0xC9, 
//---------------
0xE5, 0xC5, 0xD5, //>TFT_char_fill (input A) $9389(+0x0050)
0x6F, 0x26, 0x00, 0x0E, 0x04, 0x37, 0x3F, 0xCB, 0x15, 0xCB, 0x14, 0x0D, 0x20, 0xF7,
0x16, 0x2C, 0xCD, 0x09, 0xFC, 
0xED, 0x4B, 0x00, 0xFE, 0x09, // LD BC, ($FE00) / ADD HL, BC
0x06, 0x10, 0x0E, 0x08, 0x1E, 0x80, 0x7B, 0xCB, 0x0B, 0xA6, 0x20, 0x10, 
0x3A, 0x0A, 0xFE, 0x57, 0xCD, 0x0D, 0xFC, 
0x3A, 0x0B, 0xFE, 0x57, 0xCD, 0x0D, 0xFC, 
0x18, 0x0E, 
0x3A, 0x08, 0xFE, 0x57, 0xCD, 0x0D, 0xFC, 
0x3A, 0x09, 0xFE, 0x57, 0xCD, 0x0D, 0xFC, 
...
0x16, 0x2A, 0xCD, 0x09, 0xFC, //Column address set com
0x16, 0x00, 0xCD, 0x0D, 0xFC, 
0x16, 0x10, 0xCD, 0x0D, 0xFC, 
0x16, 0x00, 0xCD, 0x0D, 0xFC, 
0x16, 0xEF, 0xCD, 0x0D, 0xFC, 
0x16, 0x2B, 0xCD, 0x09, 0xFC, //Page address set com
0x16, 0x00, 0xCD, 0x0D, 0xFC, 
0x16, 0x00, 0xCD, 0x0D, 0xFC, 
0x16, 0x01, 0xCD, 0x0D, 0xFC, 
0x16, 0x3F, 0xCD, 0x0D, 0xFC, 

0x16, 0x2C, 0xCD, 0x09, 0xFC, 
0xC5, 0x06, 0xFF, 0x0E, 0xE8, 
0x3A, 0x0A, 0xFE, 0x57, 0xCD, 0x0D, 0xFC, //rg
0x3A, 0x0B, 0xFE, 0x57, 0xCD, 0x0D, 0xFC, //gb
...
0x16, 0x36, 0xCD, 0x09, 0xFC, // com (0x36) Memory access control MV=1;
0x16, 0x28, 0xCD, 0x0D, 0xFC, 
0xC9, 
...
//---------------------------
//----------------------------------------------------------- TFT ILI9341 init.
0x16, 0xC0, 0xCD, 0x09, 0xFC, // com (0xC0) Power control
0x16, 0x17, 0xCD, 0x0D, 0xFC, // GVDD < (Vcc-0.5V)
0x16, 0xC1, 0xCD, 0x09, 0xFC, // com (0xC1) Power control
0x16, 0x10, 0xCD, 0x0D, 0xFC, // default
0x16, 0xC5, 0xCD, 0x09, 0xFC, // com (0xC5) VCM control
0x16, 0x31, 0xCD, 0x0D, 0xFC, // VCOMH = 3.925V (Contrast)
0x16, 0x3C, 0xCD, 0x0D, 0xFC, // VCOML = -1.0V
0x16, 0xC7, 0xCD, 0x09, 0xFC, // com (0xC7) VCM control2
0x16, 0x86, 0xCD, 0x0D, 0xFC, // nVM = 1; VMF = -58
0x16, 0xB1, 0xCD, 0x09, 0xFC, // com (0xB1) Frame Rate Control
0x16, 0x00, 0xCD, 0x0D, 0xFC, // fosc
0x16, 0x18, 0xCD, 0x0D, 0xFC, // 24 clk/line

0x16, 0xB6, 0xCD, 0x09, 0xFC, // com (0xB6) Display function control
0x16, 0x08, 0xCD, 0x0D, 0xFC, // PTG = interval scan; PT = +V63 - V0
0x16, 0x82, 0xCD, 0x0D, 0xFC, // REV = white; GS = 1->320; SS = 1->720; SM = 0;
0x16, 0x27, 0xCD, 0x0D, 0xFC, // NL = 320 lines
0x16, 0x3A, 0xCD, 0x09, 0xFC, // com (0x3A) Pixel format set
0x16, 0x55, 0xCD, 0x0D, 0xFC, // DPI 16bit; DBI 16bit
0x16, 0x38, 0xCD, 0x09, 0xFC, // com (0x38) Idle mode OFF
0x16, 0x11, 0xCD, 0x09, 0xFC, // com (0x11) Exit sleep

0x06, 0xFF, 0xCD, 0x04, 0xFC, // pause 100ms
0x16, 0x29, 0xCD, 0x09, 0xFC, // com (0x29) Display on
0x16, 0x2C, 0xCD, 0x09, 0xFC, // com (0x2C)

0x16, 0x36, 0xCD, 0x09, 0xFC, // com (0x36) Memory access control
0x16, 0x08, 0xCD, 0x0D, 0xFC, // MY=0; MX=0; MV=0; ML=0; BGR=1; MH=0
//--------------------------------------------------------------------------- TFT fill background
0x16, 0x2C, 0xCD, 0x09, 0xFC, //Mem write com backcolor
...
0x16, 0x36, 0xCD, 0x09, 0xFC, // com (0x36) Memory access control
0x16, 0x28, 0xCD, 0x0D, 0xFC, // MY=0; MX=0; MV=1; ML=0; BGR=1; MH=0
//----------------------------------------------------------------------- TFT intro
