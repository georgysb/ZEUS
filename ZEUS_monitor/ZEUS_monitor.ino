...
0xFB, 0xED, 0x4D, //>SIO void handler 0x9300(+0x0003)
//---------------
0x0E, 0xFF, 0x0D, 0x20, 0xFD, 0x05, 0x20, 0xF8, 0xC9, //>Pause (input B)*4103 ticks 0x9303(+0x0009)
//---------------
...
0xC5, 0xE5, //>Hex parse (input DE output A) 0x9500(+0x0042)
...
0x7E, 0xE1, 0xC1, 0xC9, 
//---------------
0xC5, 0xE5, 0x4F, //>Hex print (input A) 0x9542(+0x002A)
...
0xE1, 0xC1, 0xC9, 
//---------------
0xC5, 0xE5, 0x3A, 0x05, 0xFE, 0x67, //>Cmdline parser  0x958B(+0x00CE)
...
0x21, 0x00, 0x00, 0x11, 0x00, 0x80, 0x01, 0x00, 0x30, 0xED, 0xB0, //copy 0x3000 bytes block 0x0000 -> 0x8000
0x21, 0x00, 0xA0, //HL <-  new setup address
