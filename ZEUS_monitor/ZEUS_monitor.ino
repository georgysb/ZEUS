...
//---------------
0x7A, 0xD3, 0x11, 0x3E, 0x21, 0xD3, 0x10, 0x3E, 0x71, 0xD3, 0x10, 0xC9, // TFT_wr_com (input D) 0x930C(+0x000C)
0x7A, 0xD3, 0x11, 0x3E, 0xA1, 0xD3, 0x10, 0x3E, 0xF1, 0xD3, 0x10, 0xC9, // TFT_wr_data (input D) 0x9318(+0x000C)
0x7A, 0xD3, 0x11, 0x3E, 0xC1, 0xD3, 0x10, 0x3E, 0xF1, 0xD3, 0x10, 0xC9, // TFT_rd_data (input D) 0x9324(+0x000C)
//---------------
...
0x2E, 0x00, 0x11, 0x2D, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x10, 0x1C, 0xE5, 0x7D, 0x21, 0x04, 0xFE, 0xBE, 0xE1, 0x20, 0xF1, 0xCD, 0x00, 0x97, 0xE1, 0xC1, 0xC9, // "clr" check(26)
0x2E, 0x00, 0x11, 0x24, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x7E, 0x97, 0xE1, 0xC1, 0xC9, // "dump " check(21)
0x2E, 0x00, 0x11, 0x3F, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xEA, 0x97, 0xE1, 0xC1, 0xC9, // "send " check
0x2E, 0x00, 0x11, 0x44, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x2F, 0x98, 0xE1, 0xC1, 0xC9, // "sysr " check
0x2E, 0x00, 0x11, 0x35, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x4B, 0x98, 0xE1, 0xC1, 0xC9, // "load " check
0x2E, 0x00, 0x11, 0x30, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x86, 0x98, 0xE1, 0xC1, 0xC9, // "jump " check
0x2E, 0x00, 0x11, 0x3A, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xA0, 0x98, 0xE1, 0xC1, 0xC9, // "exec " check
...
0x16, 0x36, 0xCD, 0x0C, 0x93, 	//>"clr" command 0x9700(+0x007E)
...
0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, // "dump " command 0x977E(+0x006C)
...
0xD9, 0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, //>"send " command 0x97EA(+0x0045)
...
0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, //>"sysr " command 0x982F(+0x001C)
...
0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, //>"load " command 0x984B(+0x003B)
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x47, 
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
...
0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, //>"jump " command 0x9886(+0x001A)
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x47, 
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
0xC5, 0xE1, 0xE9, 0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x04, 0x01, 0x00, 0x80, //>"exeс " command 0x98A0(+0x0035)
...
//    for(int j=0; j<0x4000; j++){writeEEPROM(0x3f00 + j, 0xFF); byteswrit++;}
