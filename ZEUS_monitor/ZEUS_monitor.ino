...
0x73, 0x79, 0x73, 0x72, 0x20, // 0x8035 "sysr "
0x6C, 0x6F, 0x61, 0x64, 0x20, // 0x803A "load "
0x6D, 0x6F, 0x76, 0x65, 0x20, // 0x803F "move "
0x6A, 0x75, 0x6D, 0x70, 0x20, // 0x8044 "jump "
0x65, 0x78, 0x65, 0x63, 0x20, // 0x8049 "exeс "
0x63, 0x72, 0x63, 0x37, 0x20, // 0x804E "crc7 "
0x73, 0x64, 0x69, 0x20,       // 0x8053 "sdi "
0xFF};
...
0xC5, 0xE5, //>Hex parse (input DE output A) $9500(+0x0042)
0x01, 0x10, 0x00, 0x21, 0x27, 0x80, 0x7A, 0xED, 0xB9, 0x79, 0x21, 0xFF, 0xFE, 0x28, 0x0D, 
0x01, 0x10, 0x00, 0x21, 0x17, 0x80, 0x7A, 0xED, 0xB9, 0x79, 0x21, 0xFF, 0xFE, 0xED, 0x6F, 
0x01, 0x10, 0x00, 0x21, 0x27, 0x80, 0x7B, 0xED, 0xB9, 0x79, 0x21, 0xFF, 0xFE, 0x28, 0x0D, 
0x01, 0x10, 0x00, 0x21, 0x17, 0x80, 0x7B, 0xED, 0xB9, 0x79, 0x21, 0xFF, 0xFE, 0xED, 0x6F, 
0x7E, 0xE1, 0xC1, 0xC9, 
//---------------
0xC5, 0xE5, 0x4F, //>Hex print (input A) $9542(+0x002A)
...
0xE1, 0xC1, 0xC9, 
//---------------
0xC5, 0xE5, //>syntax error $956C(+0x001F)
...
0xE1, 0xC1, 0xC9, 
//---------------
0xC5, 0xE5, 0x3A, 0x05, 0xFE, 0x67, //>Cmdline parser  $958B(+0x00CE)
...
0x2E, 0x00, 0x11, 0x35, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x2F, 0x98, 0xE1, 0xC1, 0xC9, // "sysr " check
0x2E, 0x00, 0x11, 0x3A, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x4B, 0x98, 0xE1, 0xC1, 0xC9, // "load " check
0x2E, 0x00, 0x11, 0x3F, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x86, 0x98, 0xE1, 0xC1, 0xC9, // "move " check
0x2E, 0x00, 0x11, 0x44, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xCD, 0x98, 0xE1, 0xC1, 0xC9, // "jump " check
0x2E, 0x00, 0x11, 0x49, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0xE7, 0x98, 0xE1, 0xC1, 0xC9, // "exec " check
0x2E, 0x00, 0x11, 0x4E, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x1C, 0x99, 0xE1, 0xC1, 0xC9, // "crc7 " check
0x2E, 0x00, 0x11, 0x53, 0x80, 0x2C, 0x1A, 0xBE, 0x20, 0x0B, 0x1C, 0xFE, 0x20, 0x20, 0xF6, 0xCD, 0x57, 0x99, 0xE1, 0xC1, 0xC9, // "sdi " check
...
0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, //>"sysr " command $982F(+0x001C)
...
0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, //>"load " command $984B(+0x003B)
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x47, 
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
...
0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, //>"move " command $9886(+0x0047)
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x47, 0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
0xC5, 0xDD, 0xE1, 
0x2C, 0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x47, 0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
0xC5, 0xFD, 0xE1, 
...
0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x05, //>"jump " command $98CD(+0x001A)
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x47, 
0x2C, 0x56, 0x2C, 0x5E, 0xCD, 0x00, 0x95, 0x4F, 
0xC5, 0xE1, 0xE9, 0xC9, 
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x04, 0x01, 0x00, 0x01, //>"exeс " command $98E7(+0x0035)
...
//---------------
0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x04, 0x01, 0x00, 0x01, //>"crc7 " command $991C(+0x003B)
...
0xC9, 
//---------------
0xDD, 0x21, 0xFE, 0xFE, 0x3A, 0x05, 0xFE, 0x67, 0x2E, 0x03, //>"sdi " command (L bytes at $0100) $9957(+0x0039)
...
const byte BLOCK_SD[] = {
0xC5, 0xE1, 0x7E, 0x26, 0xFC, 0x77, 0xAF, 0xBD, 0x28, 0x04, 0x2D, 0x60, 0x18, 0xF4, //crc7_add [input BC last byte pointer] $9A00(+0x003D)
...
//---------------
0xAF, 
0xC8, 0x7E, 0xC8, 0xCF, 0x20, 0x02, 0xC8, 0x8F, 0xC8, 0xDF, 0xD3, 0x01, 0xC8, 0x9F, 0xD3, 0x01, //SD wr byte [input HL] $9A3D(+0x0082)
...
0xC9, 
//---------------
0xC5, 0x0E, 0x08, //SD rd byte [output (HL)] $9ABF(+0x0018)
...
0x16, 0x25, 0x1E, 0x0E, 0xCD, 0x30, 0x93, 0x3E, 0xFF, 0x90, 0xCD, 0x42, 0x95, //aval. banks number print
...
//    for(int j=0; j<0x0100; j++){writeEEPROM(0x2100 + j, 0xFF); byteswrit++;}
